...
re-evaluate on refresh, and the `refresh(ctx)` orchestrator
composes both. **Total: 25 modules, 884 assertions, all passing in
Phase 0** (pure-Aether, no GTK/display dependency).
